  ...
  return (
    <section id="experience" className="max-w-full mx-auto mb-10 md:mb-20">
      ...
      <div className="bg-white">
        <div className="xl:container mx-auto pt-auto">
          <div className="flex flex-row flex-wrap">
            <div className="flex-shrink max-w-full w-full lg:w-1/2 grayscale-[40%]  hover:grayscale-[0%]">
              <div className="box-one flex flex-row flex-wrap">
                {experiencesData
                  .filter((e, i) => i > 3 && i < 6)
                  .map((props, index) => (
            ...
            <div className="flex-shrink max-w-full w-full lg:w-1/2 grayscale-[60%]  hover:grayscale-[0%]">
              <div className="box-one flex flex-row flex-wrap">
                {experiencesData
                  .filter((e, i) => i >= 6 && i < 7)
                  .map((props, index) => (
