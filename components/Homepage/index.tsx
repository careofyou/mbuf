...
export default function Homepage({ posts, projects }: Props) {
  ...
  return (
    <>
      ...
      <FadeIn>
        <section className="max-w-3xl px-5 py-6 mx-auto mt-20 mb-20 text-center top-10 bg-blue-200  border-2 border-gray-200 border-dotted rounded-lg md:mb-20 md:mt-32 md:py-12 md:px-14">
